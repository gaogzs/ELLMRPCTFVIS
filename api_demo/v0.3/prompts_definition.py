...
You should list out one object perline, each line consists of a non-repetitive variable name in python case and a brief translation (not a complete description) of what the variable name represents separated by \":\". For example, if the story mentions \"Aleph is a brown dog living in Mount Everest with a leopard cat.\" You may give output like:
\"
