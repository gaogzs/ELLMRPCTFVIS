...
def multi_value_scoring(dir, score_keyword, metrics_used=["average"], store_keyword=""):
    ...
    if metrics_used is None:
        metrics_used = list(eval_hists[0][0][score_keyword].keys())
    # Iterate through the evaluation history
    score_hists = {}
...
if __name__ == "__main__":
    multi_value_scoring(dir="output_multiple-scoring-amazon-bedrock_1_shot.json", score_keyword="chat_evaluation", metrics_used=None)